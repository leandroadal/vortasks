        ...
        child: Column(
          ...
          children: [
            ...
            Observer(
              builder: (_) => BackupCategoryItem(
                title: 'Missões',
                data: backup.missions,
                categoryName: 'Missions',
                isExpanded:
                    _backupStore.expandedCategories['Missions'] ?? false,
                onExpansionChanged: (value) =>
                    _backupStore.setExpandedCategory('Missions', value),
              ),
            ),
            Observer(
              builder: (_) => BackupCategoryItem(
            ...
            Observer(
              builder: (_) => BackupCategoryItem(
                ...
                data: backup.checkInDays,
                categoryName: 'CheckInDays',
                isExpanded:
