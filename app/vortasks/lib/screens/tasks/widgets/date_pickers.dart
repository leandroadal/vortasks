...
class DatePickerField extends StatelessWidget {
  ...
  final DateTime? minimumDate; // Data mínima permitida
  final DateTime? maximumDate; // Data máxima permitida
  final BuildContext? context; // Contexto para mostrar o SnackBar
