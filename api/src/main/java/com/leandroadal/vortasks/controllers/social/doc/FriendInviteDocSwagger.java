...
public @interface FriendInviteDocSwagger {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Convite de amizade encontrado com sucesso", content = { @Content(mediaType = "application/json", 
        schema = @Schema(implementation = FriendInviteResponseDTO.class)) }),
        @ApiResponse(responseCode = "400", description = "IDs de usuário inválidos",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "403", description = "Acesso negado", 
                content = @Content(schema = @Schema(implementation = StandardError.class))),
        @ApiResponse(responseCode = "404", description = "Convite de amizade não encontrado",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
    ...
    @Target({ElementType.METHOD})
    @Retention(RetentionPolicy.RUNTIME)
    @Operation(summary = "Listar meus convites de amizade", description = "Lista todos os convites de amizade que o usuário recebeu ou enviou")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Convites de amizade listados com sucesso", content = { @Content(mediaType = "application/json", 
        schema = @Schema(implementation = FriendInviteResponseDTO.class)) }),
        @ApiResponse(responseCode = "403", description = "Acesso negado", 
                content = @Content(schema = @Schema(implementation = StandardError.class))),
        @ApiResponse(responseCode = "500", description = "Erro interno no servidor",
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Convite de amizade enviado com sucesso", content = { @Content(mediaType = "application/json", 
        schema = @Schema(implementation = FriendInviteResponseDTO.class)) }),
        @ApiResponse(responseCode = "400", description = "IDs de usuário inválidos",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "403", description = "Acesso negado", 
                content = @Content(schema = @Schema(implementation = StandardError.class))),
        @ApiResponse(responseCode = "409", description = "Convite de amizade já existente",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "500", description = "Erro interno no servidor",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class)))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Convite de amizade aceito com sucesso", content = { @Content(mediaType = "application/json", 
        ...
        @ApiResponse(responseCode = "404", description = "Convite de amizade não encontrado",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "409", description = "Convite de amizade já foi rejeitado",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "500", description = "Erro interno no servidor",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class)))
    })
