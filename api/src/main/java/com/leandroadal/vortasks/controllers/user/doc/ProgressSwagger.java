...
public @interface ProgressSwagger {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", description = "Dados de progresso não encontrados",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Dados de progresso atualizados com sucesso", content = { @Content(mediaType = "application/json", 
        schema = @Schema(implementation = ProgressDataResponseDTO.class)) }),
