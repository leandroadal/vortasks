...
public @interface TransactionDocSwagger {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Transação de gemas encontrada com sucesso", content = { @Content(mediaType = "application/json", 
        ...
        @ApiResponse(responseCode = "404", description = "Transação de gemas não encontrada",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Transação de produto encontrada com sucesso", content = { @Content(mediaType = "application/json", 
        schema = @Schema(implementation = ProductTransactionDTO.class)) }),
        @ApiResponse(responseCode = "400", description = "ID de transação inválido",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "403", description = "Acesso negado", 
                content = @Content(schema = @Schema(implementation = StandardError.class))),
        @ApiResponse(responseCode = "404", description = "Transação de produto não encontrada",
                content = {@Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class))}),
        @ApiResponse(responseCode = "500", description = "Erro interno no servidor",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = StandardError.class)))
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Transações listadas com sucesso", content = { @Content(mediaType = "application/json", 
