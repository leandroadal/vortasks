...
public class LogBackupService {
    ...
    protected void logBackupNotModified(String userId) {
        log.info("Backup não modificado para o usuário {}", userId);
    }

    protected void logLatestBackupRetrievalSuccess(String userId) {
    ...
    public void logFindBackup(String id) {
        log.error("Falha ao recuperar o backup com id: {}", id);
    }
}
